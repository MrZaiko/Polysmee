...
public class InvitesManagementActivityTest {
    ...
    public static void setUp() throws Exception {
        ...
        DatabaseFactory.getAdaptedInstance().getReference("appointments").child(appointmentId2).child("participants").child(MainUserSingleton.getInstance().getId()).setValue(true);
        ...
        DatabaseFactory.getAdaptedInstance().getReference("appointments").child(appointmentId3).child("participants").child(MainUserSingleton.getInstance().getId()).setValue(true);
    ...
    public void InvitesShouldProperlyDisplay() throws InterruptedException {
        ...
        DatabaseFactory.getAdaptedInstance().getReference("users").child(MainUserSingleton.getInstance().getId()).child("appointments").child(appointmentId2).setValue(true);
        sleep(1, SECONDS);
        assertDisplayed(title2);
        clickOn("REFUSE");
        DatabaseFactory.getAdaptedInstance().getReference("users").child(MainUserSingleton.getInstance().getId()).child("appointments").child(appointmentId3).setValue(true);
        sleep(1, SECONDS);
